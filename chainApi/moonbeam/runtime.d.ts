...
export interface RuntimeApis<Rv extends RpcVersion>
  ...
  accountNonceApi: {
    ...
    accountNonce: GenericRuntimeApiMethod<
      Rv,
      (account: AccountId20Like) => Promise<number>
    >;
  ...
  nimbusApi: {
    ...
    canAuthor: GenericRuntimeApiMethod<
      Rv,
      (
        author: NimbusPrimitivesNimbusCryptoPublic,
        relayParent: number,
        parentHeader: Header,
      ) => Promise<boolean>
    >;
  ...
  vrfApi: {
     ...
     **/
    getLastVrfOutput: GenericRuntimeApiMethod<
      Rv,
      () => Promise<H256 | undefined>
    >;
    ...
    vrfKeyLookup: GenericRuntimeApiMethod<
      ...
      ) => Promise<SessionKeysPrimitivesVrfVrfCryptoPublic | undefined>
    >;
  ...
  locationToAccountApi: {
    ...
    convertLocation: GenericRuntimeApiMethod<
      ...
      ) => Promise<Result<AccountId20, XcmRuntimeApisConversionsError>>
    >;
