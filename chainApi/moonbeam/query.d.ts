...
export interface ChainStorage<Rv extends RpcVersion>
  ...
  system: {
    ...
    account: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => FrameSystemAccountInfo,
      AccountId20
    >;
  ...
  balances: {
    ...
    account: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => PalletBalancesAccountData,
      AccountId20
    >;
    ...
    locks: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => Array<PalletBalancesBalanceLock>,
      AccountId20
    >;
    ...
    reserves: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => Array<PalletBalancesReserveData>,
      AccountId20
    >;
    ...
    holds: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => Array<FrameSupportTokensMiscIdAmount>,
      AccountId20
    >;
    ...
    freezes: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => Array<FrameSupportTokensMiscIdAmount002>,
      AccountId20
    >;
  ...
  parachainStaking: {
     ...
     **/
    inflationDistributionInfo: GenericStorageQuery<
      Rv,
      () => PalletParachainStakingInflationDistributionConfig
    >;
    ...
    atStake: GenericStorageQuery<
      ...
      ) => PalletParachainStakingCollatorSnapshot | undefined,
      [number, AccountId20]
    >;
     ...
     **/
    wasInactive: GenericStorageQuery<
      Rv,
      (arg: [number, AccountId20Like]) => [] | undefined,
      [number, AccountId20]
    >;
    ...
    awardedPts: GenericStorageQuery<
      Rv,
      (arg: [number, AccountId20Like]) => number,
      [number, AccountId20]
    >;
  ...
  authorFilter: {
     ...
     **/
    eligibleCount: GenericStorageQuery<
      Rv,
      () => PalletAuthorSlotFilterNumNonZeroU32
    >;
  ...
  authorMapping: {
    ...
    mappingWithDeposit: GenericStorageQuery<
      ...
      ) => PalletAuthorMappingRegistrationInfo | undefined,
      NimbusPrimitivesNimbusCryptoPublic
    >;
  ...
  moonbeamOrbiters: {
    ...
    collatorsPool: GenericStorageQuery<
      ...
      (
        arg: AccountId20Like,
      ) => PalletMoonbeamOrbitersCollatorPoolInfo | undefined,
      AccountId20
    >;
    ...
    registeredOrbiter: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => boolean | undefined,
      AccountId20
    >;
  ...
  identity: {
    ...
    superOf: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => [AccountId20, Data] | undefined,
      AccountId20
    >;
    ...
    subsOf: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => [bigint, Array<AccountId20>],
      AccountId20
    >;
    ...
    accountOfUsername: GenericStorageQuery<
      Rv,
      (arg: BytesLike) => AccountId20 | undefined,
      Bytes
    >;
    ...
    pendingUsernames: GenericStorageQuery<
      Rv,
      (arg: BytesLike) => [AccountId20, number] | undefined,
      Bytes
    >;
  ...
  moonbeamLazyMigrations: {
     ...
     * @param {Callback<[] | undefined> =} callback
     **/
    approvedForeignAssets: GenericStorageQuery<
      Rv,
  ...
  convictionVoting: {
    ...
    classLocksFor: GenericStorageQuery<
      Rv,
      (arg: AccountId20Like) => Array<[number, bigint]>,
      AccountId20
    >;
  ...
  treasuryCouncilCollective: {
    ...
    proposalOf: GenericStorageQuery<
      Rv,
      (arg: H256) => MoonbeamRuntimeRuntimeCall | undefined,
      H256
    >;
  ...
  crowdloanRewards: {
     ...
     * @param {Callback<[] | undefined> =} callback
     **/
    claimedRelayChainIds: GenericStorageQuery<
      Rv,
      (arg: FixedBytes<32>) => [] | undefined,
      FixedBytes<32>
    >;
  ...
  assets: {
    ...
    asset: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletAssetsAssetDetails | undefined,
      bigint
    >;
    ...
    metadata: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletAssetsAssetMetadata,
      bigint
    >;
  ...
  assetManager: {
     ...
     **/
    assetIdType: GenericStorageQuery<
      Rv,
      (arg: bigint) => MoonbeamRuntimeXcmConfigAssetType | undefined,
      bigint
    >;
  ...
  xcmTransactor: {
     ...
     * @param {Callback<AccountId20 | undefined> =} callback
     **/
    indexToAccount: GenericStorageQuery<
      Rv,
      (arg: number) => AccountId20 | undefined,
      number
    >;
    ...
    transactInfoWithWeightLimit: GenericStorageQuery<
      ...
      ) => PalletXcmTransactorRemoteTransactInfoWithMaxWeight | undefined,
      StagingXcmV4Location
    >;
     ...
     **/
    relayIndices: GenericStorageQuery<
      Rv,
      () => PalletXcmTransactorRelayIndicesRelayChainIndices
    >;
  ...
  evmForeignAssets: {
     ...
     **/
    assetsById: GenericStorageQuery<
      Rv,
      (arg: bigint) => StagingXcmV4Location | undefined,
      bigint
    >;
    ...
    assetsByLocation: GenericStorageQuery<
      ...
      (
        arg: StagingXcmV4Location,
      ) => [bigint, PalletMoonbeamForeignAssetsAssetStatus] | undefined,
      StagingXcmV4Location
    >;
    ...
    assetsCreationDetails: GenericStorageQuery<
      ...
      (
        arg: bigint,
      ) => PalletMoonbeamForeignAssetsAssetDepositDetails | undefined,
      bigint
    >;
  ...
  relayStorageRoots: {
     ...
     * @param {Callback<H256 | undefined> =} callback
     **/
    relayStorageRoot: GenericStorageQuery<
      Rv,
      (arg: number) => H256 | undefined,
      number
    >;
  ...
  randomness: {
     ...
     **/
    requests: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletRandomnessRequestState | undefined,
      bigint
    >;
    ...
    randomnessResults: GenericStorageQuery<
      ...
      ) => PalletRandomnessRandomnessResult | undefined,
      PalletRandomnessRequestType
    >;
