...
export interface ChainEvents<Rv extends RpcVersion>
  ...
  rootTesting: {
     ...
     **/
    DefensiveTestCall: GenericPalletEvent<
      Rv,
      "RootTesting",
      "DefensiveTestCall",
      undefined
  ...
  balances: {
    ...
    Endowed: GenericPalletEvent<
      ...
      "Balances",
      "Endowed",
      { account: AccountId20; freeBalance: bigint }
    >;
    ...
    DustLost: GenericPalletEvent<
      ...
      "Balances",
      "DustLost",
      { account: AccountId20; amount: bigint }
    >;
    ...
    Transfer: GenericPalletEvent<
      ...
      "Balances",
      "Transfer",
      { from: AccountId20; to: AccountId20; amount: bigint }
    >;
  ...
  authorFilter: {
     ...
     **/
    EligibleUpdated: GenericPalletEvent<
      Rv,
      "AuthorFilter",
      "EligibleUpdated",
      PalletAuthorSlotFilterNumNonZeroU32
  ...
  moonbeamOrbiters: {
     ...
     **/
    OrbiterUnregistered: GenericPalletEvent<
      Rv,
      "MoonbeamOrbiters",
      "OrbiterUnregistered",
      { account: AccountId20 }
  ...
  maintenanceMode: {
     ...
     **/
    EnteredMaintenanceMode: GenericPalletEvent<
      Rv,
      "MaintenanceMode",
     ...
     **/
    NormalOperationResumed: GenericPalletEvent<
      Rv,
      "MaintenanceMode",
  ...
  identity: {
    ...
    IdentityCleared: GenericPalletEvent<
      ...
      "Identity",
      "IdentityCleared",
      { who: AccountId20; deposit: bigint }
    >;
  ...
  migrations: {
     ...
     **/
    RuntimeUpgradeStarted: GenericPalletEvent<
      Rv,
      "Migrations",
     ...
     * Migration started
     **/
    MigrationStarted: GenericPalletEvent<
      Rv,
      "Migrations",
      "MigrationStarted",
      { migrationName: Bytes }
  ...
  crowdloanRewards: {
     ...
     **/
    InitialPaymentMade: GenericPalletEvent<
      Rv,
      "CrowdloanRewards",
      "InitialPaymentMade",
      [AccountId20, bigint]
     ...
     **/
    RewardsPaid: GenericPalletEvent<
      Rv,
      "CrowdloanRewards",
      "RewardsPaid",
      [AccountId20, bigint]
  ...
  assets: {
    ...
    Issued: GenericPalletEvent<
      ...
      "Assets",
      "Issued",
      { assetId: bigint; owner: AccountId20; amount: bigint }
    >;
    ...
    Burned: GenericPalletEvent<
      ...
      "Assets",
      "Burned",
      { assetId: bigint; owner: AccountId20; balance: bigint }
    >;
    ...
    OwnerChanged: GenericPalletEvent<
      ...
      "Assets",
      "OwnerChanged",
      { assetId: bigint; owner: AccountId20 }
    >;
    ...
    Frozen: GenericPalletEvent<
      ...
      "Assets",
      "Frozen",
      { assetId: bigint; who: AccountId20 }
    >;
    ...
    Deposited: GenericPalletEvent<
      ...
      "Assets",
      "Deposited",
      { assetId: bigint; who: AccountId20; amount: bigint }
    >;
  ...
  assetManager: {
     ...
     * Removed all information related to an assetId and destroyed asset
     **/
    LocalAssetDestroyed: GenericPalletEvent<
      Rv,
      "AssetManager",
      "LocalAssetDestroyed",
      { assetId: bigint }
  ...
  xcmTransactor: {
    ...
    >;
    DeRegisteredDerivative: GenericPalletEvent<
      Rv,
      "XcmTransactor",
  ...
  ethereumXcm: {
     ...
     **/
    ExecutedFromXcm: GenericPalletEvent<
      Rv,
      "EthereumXcm",
      "ExecutedFromXcm",
  ...
  evmForeignAssets: {
     ...
     **/
    TokensLocked: GenericPalletEvent<
      Rv,
      "EvmForeignAssets",
      "TokensLocked",
      [AccountId20, bigint, U256]
    >;
  ...
  emergencyParaXcm: {
     ...
     **/
    EnteredPausedXcmMode: GenericPalletEvent<
      Rv,
      "EmergencyParaXcm",
     ...
     **/
    NormalXcmOperationResumed: GenericPalletEvent<
      Rv,
      "EmergencyParaXcm",
  ...
  randomness: {
    ...
    >;
    RequestFulfilled: GenericPalletEvent<
      Rv,
      "Randomness",
      "RequestFulfilled",
      { id: bigint }
    >;
    RequestFeeIncreased: GenericPalletEvent<
      Rv,
      "Randomness",
      "RequestFeeIncreased",
      { id: bigint; newFee: bigint }
    >;
    RequestExpirationExecuted: GenericPalletEvent<
      Rv,
      "Randomness",
