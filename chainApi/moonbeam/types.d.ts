...
export type MoonbeamRuntimeRuntimeEvent =
  ...
  | {
      ...
      palletEvent: PalletMoonbeamForeignAssetsEvent;
    }
...
export type PalletBalancesEvent =
  ...
  | {
      name: "Transfer";
      data: { from: AccountId20; to: AccountId20; amount: bigint };
    }
  /**
...
export type PalletTransactionPaymentEvent =
   ...
   **/
  {
    ...
    data: { who: AccountId20; actualFee: bigint; tip: bigint };
  };
...
export type PalletParachainStakingEvent =
  ...
  | {
      ...
      data: { candidate: AccountId20; amount: bigint; newTotalBond: bigint };
    }
  /**
  ...
  | {
      ...
      data: { candidate: AccountId20; amount: bigint; newBond: bigint };
    }
  /**
  ...
  | {
      ...
      data: { candidate: AccountId20; amount: bigint; executeRound: number };
    }
  /**
  ...
  | {
      ...
      data: { round: number; delegator: AccountId20; scheduledExit: number };
    }
  /**
  ...
  | {
      name: "DelegatorLeft";
      data: { delegator: AccountId20; unstakedAmount: bigint };
    }
  /**
   * Delegation revoked.
   **/
  ...
  | {
      ...
      data: { index: number; account: AccountId20; value: bigint };
    }
  | {
  ...
  | {
      ...
      data: { candidate: AccountId20; delegator: AccountId20; value: Percent };
    }
  /**
  ...
  | {
      name: "Compounded";
      data: { candidate: AccountId20; delegator: AccountId20; amount: bigint };
    };
...
export type PalletParachainStakingInflationDistributionAccount = {
  account: AccountId20;
  percent: Percent;
};
...
export type PalletMoonbeamOrbitersEvent =
  ...
  | {
      ...
      data: { collator: AccountId20; orbiter: AccountId20 };
    }
  /**
  ...
  | {
      ...
      data: { account: AccountId20; deposit: bigint };
    }
  /**
...
export type PalletProxyEvent =
  ...
  | {
      name: "Announced";
      data: { real: AccountId20; proxy: AccountId20; callHash: H256 };
    }
  /**
   * A proxy was added.
   **/
...
export type PalletIdentityEvent =
  ...
  | {
      ...
      data: { who: AccountId20; registrarIndex: number };
    }
  /**
  ...
  | {
      name: "JudgementGiven";
      data: { target: AccountId20; registrarIndex: number };
    }
  /**
  ...
  | {
      ...
      data: { sub: AccountId20; main: AccountId20; deposit: bigint };
    }
  /**
  ...
  | {
      name: "UsernameQueued";
      data: { who: AccountId20; username: Bytes; expiration: number };
    }
  /**
  ...
  | {
      ...
      data: { who: AccountId20; username: Bytes };
    };
...
export type PalletMigrationsEvent =
  ...
  | {
      ...
      data: { weight: SpWeightsWeightV2Weight };
    }
  /**
   * Migration started
   **/
  ...
  | {
      ...
      data: { migrationName: Bytes; consumedWeight: SpWeightsWeightV2Weight };
    }
  /**
...
export type MoonbeamRuntimeRuntimeParamsRuntimeParametersKey =
  | {
      type: "RuntimeConfig";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsRuntimeConfigParametersKey;
    }
  | {
      type: "PalletRandomness";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsPalletRandomnessParametersKey;
    }
  | {
      type: "XcmConfig";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsXcmConfigParametersKey;
    };
...
export type MoonbeamRuntimeRuntimeParamsRuntimeParametersValue =
  | {
      type: "RuntimeConfig";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsRuntimeConfigParametersValue;
    }
  | {
      type: "PalletRandomness";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsPalletRandomnessParametersValue;
    }
  | {
      type: "XcmConfig";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsXcmConfigParametersValue;
    };
...
export type MoonbeamRuntimeRuntimeParamsDynamicParamsPalletRandomnessParametersValue =
  { type: "Deposit"; value: MoonbeamRuntimeCommonBoundedU128 };
...
export type MoonbeamRuntimeRuntimeParamsDynamicParamsXcmConfigParametersValue =
  { type: "ForeignAssetCreationDeposit"; value: bigint };
...
export type PalletConvictionVotingEvent =
  ...
  | {
      name: "Voted";
      data: { who: AccountId20; vote: PalletConvictionVotingVoteAccountVote };
    }
  /**
...
export type MoonbeamRuntimeRuntimeCall =
  ...
  | {
      ...
      palletCall: PalletMoonbeamLazyMigrationsCall;
    }
...
export type MoonbeamRuntimeRuntimeCallLike =
  ...
  | {
      pallet: "MoonbeamLazyMigrations";
      palletCall: PalletMoonbeamLazyMigrationsCallLike;
    }
  ...
  | {
      pallet: "EvmForeignAssets";
      palletCall: PalletMoonbeamForeignAssetsCallLike;
    }
...
export type MoonbeamRuntimeOriginCaller =
  ...
  | {
      type: "Origins";
      value: MoonbeamRuntimeGovernanceOriginsCustomOriginsOrigin;
    }
...
export type PalletEthereumXcmRawOrigin = {
  type: "XcmEthereumTransaction";
  value: H160;
};
...
export type PalletIdentityCall =
  ...
  | {
      ...
      params: { authority: AccountId20; suffix: Bytes; allocation: number };
    }
  /**
...
export type MoonbeamRuntimeRuntimeParamsRuntimeParameters =
  | {
      type: "RuntimeConfig";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsRuntimeConfigParameters;
    }
  | {
      type: "PalletRandomness";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsPalletRandomnessParameters;
    }
  | {
      type: "XcmConfig";
      value: MoonbeamRuntimeRuntimeParamsDynamicParamsXcmConfigParameters;
    };
...
export type PalletCrowdloanRewardsCallLike =
  ...
  | {
      name: "InitializeRewardVec";
      params: {
        rewards: Array<[FixedBytes<32>, AccountId20Like | undefined, bigint]>;
      };
    };
...
export type XcmV2Junction =
  ...
  | {
      type: "AccountId32";
      value: { network: XcmV2NetworkId; id: FixedBytes<32> };
    }
  | {
      type: "AccountIndex64";
      value: { network: XcmV2NetworkId; index: bigint };
    }
  | {
      type: "AccountKey20";
      value: { network: XcmV2NetworkId; key: FixedBytes<20> };
    }
  | { type: "PalletInstance"; value: number }
  | { type: "GeneralIndex"; value: bigint }
...
export type XcmV2Instruction =
  ...
  | {
      ...
      value: { queryId: bigint; maxResponseWeight: bigint };
    }
...
export type PalletAssetsCall =
  ...
  | {
      name: "TransferAll";
      params: { id: bigint; dest: AccountId20; keepAlive: boolean };
    };
...
export type MoonbeamRuntimeXcmConfigAssetType = {
  type: "Xcm";
  value: StagingXcmV3MultilocationMultiLocation;
};
...
export type PalletXcmTransactorHrmpOperation =
  ...
  | {
      type: "Accept";
      value: { paraId: PolkadotParachainPrimitivesPrimitivesId };
    }
...
export type PalletTreasuryEvent =
  ...
  | {
      name: "Awarded";
      data: { proposalIndex: number; award: bigint; account: AccountId20 };
    }
  /**
  ...
  | {
      name: "SpendApproved";
      data: { proposalIndex: number; amount: bigint; beneficiary: AccountId20 };
    }
  /**
...
export type PalletCrowdloanRewardsEvent =
  ...
  | {
      ...
      data: [FixedBytes<32>, AccountId20, bigint];
    }
  /**
  ...
  | {
      ...
      data: [FixedBytes<32>, AccountId20 | undefined, bigint];
    }
  /**
   * When initializing the reward vec an already initialized account was found
   **/
...
export type CumulusPalletXcmEvent =
  ...
  | {
      ...
      data: [FixedBytes<32>, StagingXcmV4TraitsOutcome];
    };
...
export type StagingXcmV4TraitsOutcome =
  ...
  | {
      type: "Incomplete";
      value: { used: SpWeightsWeightV2Weight; error: XcmV3TraitsError };
    }
...
export type PalletXcmEvent =
  ...
  | {
      ...
      data: { origin: StagingXcmV4Location; queryId: bigint };
    }
  /**
  ...
  | {
      name: "ResponseReady";
      data: { queryId: bigint; response: StagingXcmV4Response };
    }
  /**
  ...
  | {
      ...
      data: { location: StagingXcmV4Location; version: number };
    }
  /**
  ...
  | {
      name: "FeesPaid";
      data: { paying: StagingXcmV4Location; fees: StagingXcmV4AssetAssets };
    }
  /**
...
export type PalletAssetsEvent =
  ...
  | {
      name: "Created";
      data: { assetId: bigint; creator: AccountId20; owner: AccountId20 };
    }
  /**
  ...
  | {
      name: "Issued";
      data: { assetId: bigint; owner: AccountId20; amount: bigint };
    }
  /**
  ...
  | {
      name: "Burned";
      data: { assetId: bigint; owner: AccountId20; balance: bigint };
    }
  /**
  ...
  | {
      ...
      data: { assetId: bigint; owner: AccountId20; delegate: AccountId20 };
    }
  /**
  ...
  | {
      ...
      data: { assetId: bigint; newMinBalance: bigint };
    }
  /**
  ...
  | {
      name: "Touched";
      data: { assetId: bigint; who: AccountId20; depositor: AccountId20 };
    }
  /**
  ...
  | {
      name: "Deposited";
      data: { assetId: bigint; who: AccountId20; amount: bigint };
    }
  /**
...
export type PalletAssetManagerEvent =
  ...
  | {
      ...
      data: { assetId: bigint; assetType: MoonbeamRuntimeXcmConfigAssetType };
    }
  /**
  ...
  | {
      ...
      data: { assetType: MoonbeamRuntimeXcmConfigAssetType };
    }
  /**
...
export type PalletXcmTransactorEvent =
  ...
  | {
      ...
      data: { feePayer: AccountId20; dest: StagingXcmV4Location; call: Bytes };
    }
  /**
  ...
  | {
      ...
      data: { accountId: AccountId20; index: number };
    }
  ...
  | {
      ...
      data: { location: StagingXcmV4Location; feePerSecond: bigint };
    }
  /**
  ...
  | {
      ...
      data: { location: StagingXcmV4Location };
    }
  /**
  ...
  | {
      ...
      data: { action: PalletXcmTransactorHrmpOperation };
    };
...
export type PalletMoonbeamForeignAssetsEvent =
  ...
  | {
      name: "ForeignAssetFrozen";
      data: { assetId: bigint; xcmLocation: StagingXcmV4Location };
    }
  | {
      name: "ForeignAssetUnfrozen";
      data: { assetId: bigint; xcmLocation: StagingXcmV4Location };
    }
  /**
...
export type PalletXcmWeightTraderEvent =
  ...
  | {
      ...
      data: { location: StagingXcmV4Location; relativePrice: bigint };
    }
  /**
   * Changed the amount of units we are charging per execution second for a given asset
   **/
  | {
      name: "SupportedAssetEdited";
      data: { location: StagingXcmV4Location; relativePrice: bigint };
    }
  /**
...
export type FrameSupportTokensMiscIdAmount = {
  id: MoonbeamRuntimeRuntimeHoldReason;
  amount: bigint;
};
...
export type PalletParachainStakingSetBoundedOrderedSet =
  Array<PalletParachainStakingBond>;
...
export type PalletMoonbeamLazyMigrationsForeignAssetForeignAssetMigrationStatus =
    ...
    | {
        type: "Migrating";
        value: PalletMoonbeamLazyMigrationsForeignAssetForeignAssetMigrationInfo;
      };

export type PalletMoonbeamLazyMigrationsForeignAssetForeignAssetMigrationInfo =
  { assetId: bigint; remainingBalances: number; remainingApprovals: number };
...
export type PalletPreimageOldRequestStatus =
  | {
      type: "Unrequested";
      value: { deposit: [AccountId20, bigint]; len: number };
    }
  | {
      type: "Requested";
      value: {
...
export type PalletPreimageRequestStatus =
  | {
      type: "Unrequested";
      value: {
        ticket: [AccountId20, FrameSupportTokensFungibleHoldConsideration];
        len: number;
      };
    }
  | {
      ...
      value: {
        maybeTicket?:
          | [AccountId20, FrameSupportTokensFungibleHoldConsideration]
          | undefined;
        count: number;
...
export type PalletMoonbeamForeignAssetsAssetStatus =
  | "Active"
  | "FrozenXcmDepositAllowed"
  | "FrozenXcmDepositForbidden";

export type PalletMoonbeamForeignAssetsAssetDepositDetails = {
...
export type PalletRandomnessRequestType =
  | { type: "BabeEpoch"; value: bigint }
...
export type MoonbeamRuntimeRuntimeError =
  ...
  | {
      pallet: "MoonbeamLazyMigrations";
      palletError: PalletMoonbeamLazyMigrationsError;
    }
  ...
  | {
      pallet: "PrecompileBenchmarks";
      palletError: PalletPrecompileBenchmarksError;
    }
