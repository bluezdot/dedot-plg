...
export interface VersionedNodeSubtensorApi<Rv extends RpcVersion>
...
/**
 * @name: NodeSubtensorApi
 * @specVersion: 277
 **/
export interface NodeSubtensorApi {
  legacy: VersionedNodeSubtensorApi<RpcLegacy>;
  v2: VersionedNodeSubtensorApi<RpcV2>;
}
