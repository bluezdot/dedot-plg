...
export interface RuntimeApis<Rv extends RpcVersion>
  ...
  inflation: {
     ...
     **/
    experimentalInflationPredictionInfo: GenericRuntimeApiMethod<
      Rv,
      () => Promise<RelayCommonApisInflationInfo>
    >;
  ...
  parachainHost: {
     ...
     **/
    validators: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Array<PolkadotPrimitivesV8ValidatorAppPublic>>
    >;
     ...
     **/
    availabilityCores: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Array<PolkadotPrimitivesVstagingCoreState>>
    >;
    ...
    candidatePendingAvailability: GenericRuntimeApiMethod<
      ...
      (
        ...
        PolkadotPrimitivesVstagingCommittedCandidateReceiptV2 | undefined
      >
    >;
     ...
     **/
    candidateEvents: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Array<PolkadotPrimitivesVstagingCandidateEvent>>
    >;
     ...
     **/
    onChainVotes: GenericRuntimeApiMethod<
      Rv,
      () => Promise<PolkadotPrimitivesVstagingScrapedOnChainVotes | undefined>
    >;
     ...
     * @param {number} index
     **/
    sessionInfo: GenericRuntimeApiMethod<
      Rv,
      (index: number) => Promise<PolkadotPrimitivesV8SessionInfo | undefined>
    >;
    ...
    sessionExecutorParams: GenericRuntimeApiMethod<
      ...
      (
        sessionIndex: number,
      ) => Promise<PolkadotPrimitivesV8ExecutorParams | undefined>
    >;
    ...
    keyOwnershipProof: GenericRuntimeApiMethod<
      ...
      (
        ...
        PolkadotPrimitivesV8SlashingOpaqueKeyOwnershipProof | undefined
      >
    >;
    ...
    paraBackingState: GenericRuntimeApiMethod<
      ...
      (
        ...
        PolkadotPrimitivesVstagingAsyncBackingBackingState | undefined
      >
    >;
     ...
     **/
    asyncBackingParams: GenericRuntimeApiMethod<
      Rv,
      () => Promise<PolkadotPrimitivesV8AsyncBackingAsyncBackingParams>
    >;
     ...
     **/
    disabledValidators: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Array<PolkadotPrimitivesV8ValidatorIndex>>
    >;
     ...
     **/
    approvalVotingParams: GenericRuntimeApiMethod<
      Rv,
      () => Promise<PolkadotPrimitivesV8ApprovalVotingParams>
    >;
  ...
  beefyApi: {
     ...
     **/
    beefyGenesis: GenericRuntimeApiMethod<
      Rv,
     ...
     **/
    validatorSet: GenericRuntimeApiMethod<
      Rv,
      () => Promise<SpConsensusBeefyValidatorSet | undefined>
    >;
  ...
  mmrApi: {
     ...
     **/
    mmrRoot: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Result<H256, SpMmrPrimitivesError>>
    >;
    ...
    mmrLeafCount: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Result<bigint, SpMmrPrimitivesError>>
    >;
    ...
    generateProof: GenericRuntimeApiMethod<
      ...
      (
        ...
        Result<
          [Array<SpMmrPrimitivesEncodableOpaqueLeaf>, SpMmrPrimitivesLeafProof],
          SpMmrPrimitivesError
        >
      >
    >;
  ...
  beefyMmrApi: {
     ...
     **/
    authoritySetProof: GenericRuntimeApiMethod<
      Rv,
      () => Promise<SpConsensusBeefyMmrBeefyAuthoritySet>
    >;
     ...
     **/
    nextAuthoritySetProof: GenericRuntimeApiMethod<
      Rv,
      () => Promise<SpConsensusBeefyMmrBeefyAuthoritySet>
    >;
