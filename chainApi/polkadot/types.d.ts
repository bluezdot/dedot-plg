...
export type PolkadotRuntimeRuntimeEvent =
  ...
  | {
      ...
      palletEvent: PolkadotRuntimeParachainsInclusionPalletEvent;
    }
  ...
  | {
      ...
      palletEvent: PolkadotRuntimeParachainsDisputesPalletEvent;
    }
  | {
      pallet: "OnDemand";
      palletEvent: PolkadotRuntimeParachainsOnDemandPalletEvent;
    }
  | {
      pallet: "Registrar";
      palletEvent: PolkadotRuntimeCommonParasRegistrarPalletEvent;
    }
  | { pallet: "Slots"; palletEvent: PolkadotRuntimeCommonSlotsPalletEvent }
  | {
      pallet: "Auctions";
      palletEvent: PolkadotRuntimeCommonAuctionsPalletEvent;
    }
  | {
      pallet: "Crowdloan";
      palletEvent: PolkadotRuntimeCommonCrowdloanPalletEvent;
    }
  | {
      pallet: "Coretime";
      palletEvent: PolkadotRuntimeParachainsCoretimePalletEvent;
    }
...
export type PolkadotRuntimeRuntimeCall =
  ...
  | {
      ...
      palletCall: PolkadotRuntimeParachainsConfigurationPalletCall;
    }
  | {
      pallet: "ParasShared";
      palletCall: PolkadotRuntimeParachainsSharedPalletCall;
    }
  | {
      pallet: "ParaInclusion";
      palletCall: PolkadotRuntimeParachainsInclusionPalletCall;
    }
  | {
      pallet: "ParaInherent";
      palletCall: PolkadotRuntimeParachainsParasInherentPalletCall;
    }
  | { pallet: "Paras"; palletCall: PolkadotRuntimeParachainsParasPalletCall }
  | {
      pallet: "Initializer";
      palletCall: PolkadotRuntimeParachainsInitializerPalletCall;
    }
  | { pallet: "Hrmp"; palletCall: PolkadotRuntimeParachainsHrmpPalletCall }
  | {
      pallet: "ParasDisputes";
      palletCall: PolkadotRuntimeParachainsDisputesPalletCall;
    }
  | {
      pallet: "ParasSlashing";
      palletCall: PolkadotRuntimeParachainsDisputesSlashingPalletCall;
    }
  | {
      pallet: "OnDemand";
      palletCall: PolkadotRuntimeParachainsOnDemandPalletCall;
    }
  | {
      pallet: "Registrar";
      palletCall: PolkadotRuntimeCommonParasRegistrarPalletCall;
    }
  ...
  | {
      pallet: "Crowdloan";
      palletCall: PolkadotRuntimeCommonCrowdloanPalletCall;
    }
  | {
      pallet: "Coretime";
      palletCall: PolkadotRuntimeParachainsCoretimePalletCall;
    }
...
export type PolkadotRuntimeRuntimeCallLike =
  ...
  | {
      pallet: "Configuration";
      palletCall: PolkadotRuntimeParachainsConfigurationPalletCallLike;
    }
  | {
      pallet: "ParasShared";
      palletCall: PolkadotRuntimeParachainsSharedPalletCallLike;
    }
  | {
      pallet: "ParaInclusion";
      palletCall: PolkadotRuntimeParachainsInclusionPalletCallLike;
    }
  | {
      pallet: "ParaInherent";
      palletCall: PolkadotRuntimeParachainsParasInherentPalletCallLike;
    }
  | {
      pallet: "Paras";
      palletCall: PolkadotRuntimeParachainsParasPalletCallLike;
    }
  | {
      pallet: "Initializer";
      palletCall: PolkadotRuntimeParachainsInitializerPalletCallLike;
    }
  | { pallet: "Hrmp"; palletCall: PolkadotRuntimeParachainsHrmpPalletCallLike }
  | {
      pallet: "ParasDisputes";
      palletCall: PolkadotRuntimeParachainsDisputesPalletCallLike;
    }
  | {
      pallet: "ParasSlashing";
      palletCall: PolkadotRuntimeParachainsDisputesSlashingPalletCallLike;
    }
  | {
      pallet: "OnDemand";
      palletCall: PolkadotRuntimeParachainsOnDemandPalletCallLike;
    }
  | {
      pallet: "Registrar";
      palletCall: PolkadotRuntimeCommonParasRegistrarPalletCallLike;
    }
  | { pallet: "Slots"; palletCall: PolkadotRuntimeCommonSlotsPalletCallLike }
  | {
      pallet: "Auctions";
      palletCall: PolkadotRuntimeCommonAuctionsPalletCallLike;
    }
  | {
      pallet: "Crowdloan";
      palletCall: PolkadotRuntimeCommonCrowdloanPalletCallLike;
    }
  | {
      pallet: "Coretime";
      palletCall: PolkadotRuntimeParachainsCoretimePalletCallLike;
    }
  | {
...
export type PolkadotRuntimeOriginCaller =
  ...
  | {
      type: "Origins";
      value: PolkadotRuntimeGovernanceOriginsPalletCustomOriginsOrigin;
    }
  | {
      type: "ParachainsOrigin";
      value: PolkadotRuntimeParachainsOriginPalletOrigin;
    }
...
export type PolkadotPrimitivesV8ExecutorParams =
  Array<PolkadotPrimitivesV8ExecutorParamsExecutorParam>;
...
export type PolkadotPrimitivesV8ApprovalVotingParams = {
...
export type PolkadotPrimitivesV8ValidDisputeStatementKind =
  ...
  | {
      ...
      value: Array<PolkadotCorePrimitivesCandidateHash>;
    };
...
export type PolkadotPrimitivesV8SlashingSlashingOffenceKind =
  | "ForInvalid"
  | "AgainstValid";
...
export type PalletFastUnstakeEvent =
  ...
  | {
      name: "Unstaked";
      data: { stash: AccountId32; result: Result<[], DispatchError> };
    }
  /**
...
export type PolkadotRuntimeParachainsInclusionPalletEvent =
  ...
  | {
      ...
      data: { from: PolkadotParachainPrimitivesPrimitivesId; count: number };
    };
...
export type PolkadotRuntimeParachainsParasPalletEvent =
  ...
  | {
      ...
      data: PolkadotParachainPrimitivesPrimitivesId;
    }
  /**
  ...
  | {
      name: "ActionQueued";
      data: [PolkadotParachainPrimitivesPrimitivesId, number];
    }
  /**
...
export type PolkadotRuntimeParachainsDisputesDisputeLocation =
  | "Local"
  | "Remote";

export type PolkadotRuntimeParachainsDisputesDisputeResult =
  | "Valid"
  | "Invalid";
...
export type PolkadotRuntimeCommonParasRegistrarPalletEvent =
  ...
  | {
      name: "Deregistered";
      data: { paraId: PolkadotParachainPrimitivesPrimitivesId };
    }
  | {
      name: "Reserved";
      data: {
...
export type PolkadotRuntimeCommonAuctionsPalletEvent =
  ...
  | {
      name: "AuctionStarted";
      data: { auctionIndex: number; leasePeriod: number; ending: number };
    }
  /**
  ...
  | {
      name: "Reserved";
      data: { bidder: AccountId32; extraReserved: bigint; totalAmount: bigint };
    }
  /**
  ...
  | {
      name: "WinningOffset";
      data: { auctionIndex: number; blockNumber: number };
    };
...
export type PolkadotRuntimeRuntimeFreezeReason = {
...
export type PolkadotRuntimeParachainsSharedRelayParentInfo = {
  ...
  claimQueue: Array<
    [
      PolkadotParachainPrimitivesPrimitivesId,
      Array<[number, Array<PolkadotPrimitivesV8CoreIndex>]>,
    ]
  >;
};
...
export type PolkadotRuntimeParachainsParasUpgradeStrategy =
  | "SetGoAheadSignal"
...
export type PolkadotPrimitivesV8IndexedVec =
  Array<PolkadotPrimitivesV8ValidatorAppPublic>;

export type PolkadotPrimitivesV8IndexedVecGroupIndex = Array<
  Array<PolkadotPrimitivesV8ValidatorIndex>
>;
...
export type PolkadotPrimitivesV8SlashingPendingSlashes = {
  keys: Array<
    [PolkadotPrimitivesV8ValidatorIndex, PolkadotPrimitivesV8ValidatorAppPublic]
  >;
  kind: PolkadotPrimitivesV8SlashingSlashingOffenceKind;
};
...
export type BinaryHeap =
  Array<PolkadotRuntimeParachainsOnDemandTypesReverseQueueIndex>;

export type PolkadotRuntimeParachainsOnDemandTypesReverseQueueIndex = number;

export type BinaryHeapEnqueuedOrder =
  Array<PolkadotRuntimeParachainsOnDemandTypesEnqueuedOrder>;
...
export type PolkadotRuntimeParachainsAssignerCoretimeQueueDescriptor = {
  first: number;
  last: number;
};
...
export type RelayCommonApisInflationInfo = {
...
export type PolkadotPrimitivesV8OccupiedCoreAssumption =
  | "Included"
  | "TimedOut"
  | "Free";
...
export type PolkadotPrimitivesV8AsyncBackingConstraints = {
  ...
  futureValidationCode?:
    | [number, PolkadotParachainPrimitivesPrimitivesValidationCodeHash]
    | undefined;
};

export type PolkadotPrimitivesV8AsyncBackingInboundHrmpLimitations = {
  validWatermarks: Array<number>;
};
...
export type PolkadotRuntimeRuntimeError =
  ...
  | {
      pallet: "Configuration";
      palletError: PolkadotRuntimeParachainsConfigurationPalletError;
    }
  | {
      pallet: "ParaInclusion";
      palletError: PolkadotRuntimeParachainsInclusionPalletError;
    }
  | {
      pallet: "ParaInherent";
      palletError: PolkadotRuntimeParachainsParasInherentPalletError;
    }
  ...
  | {
      pallet: "ParasDisputes";
      palletError: PolkadotRuntimeParachainsDisputesPalletError;
    }
  | {
      pallet: "ParasSlashing";
      palletError: PolkadotRuntimeParachainsDisputesSlashingPalletError;
    }
  | {
      pallet: "OnDemand";
      palletError: PolkadotRuntimeParachainsOnDemandPalletError;
    }
  | {
      pallet: "CoretimeAssignmentProvider";
      palletError: PolkadotRuntimeParachainsAssignerCoretimePalletError;
    }
  | {
      pallet: "Registrar";
      palletError: PolkadotRuntimeCommonParasRegistrarPalletError;
    }
  | { pallet: "Slots"; palletError: PolkadotRuntimeCommonSlotsPalletError }
  | {
      pallet: "Auctions";
      palletError: PolkadotRuntimeCommonAuctionsPalletError;
    }
  | {
      pallet: "Crowdloan";
      palletError: PolkadotRuntimeCommonCrowdloanPalletError;
    }
  | {
      pallet: "Coretime";
      palletError: PolkadotRuntimeParachainsCoretimePalletError;
    }
