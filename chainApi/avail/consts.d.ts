...
export interface ChainConsts<Rv extends RpcVersion>
  ...
  /**
   * Pallet `DataAvailability`'s constants
   **/
  dataAvailability: {
    /**
     * The max length of application key.
     **/
    maxAppKeyLength: number;

    /**
     * The max length of app data.
     **/
    maxAppDataLength: number;

    /**
     * Minimum number of rows in a block.
     **/
    minBlockRows: AvailCoreBlockLengthRows;

    /**
     * Maximum number of rows in a block.
     **/
    maxBlockRows: AvailCoreBlockLengthRows;

    /**
     * Minimum number of cols in a block.
     **/
    minBlockCols: AvailCoreBlockLengthColumns;

    /**
     * Maximum number of cols in a block.
     **/
    maxBlockCols: AvailCoreBlockLengthColumns;
  ...
  vector: {
     ...
     **/
    messageMappingStorageIndex: bigint;
  ...
  /**
   * Pallet `TreasuryCommittee`'s constants
   **/
  treasuryCommittee: {
    /**
     * The maximum weight of a dispatch call that can be proposed and executed.
