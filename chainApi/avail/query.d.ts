...
import type {
  ...
  PalletVectorStorageUtilsMessageStatusEnum,
...
export interface ChainStorage<Rv extends RpcVersion>
  ...
  system: {
     ...
     *
     * @param {Callback<FrameSystemExtrinsicLen | undefined> =} callback
     **/
    allExtrinsicsLen: GenericStorageQuery<
      Rv,
      () => FrameSystemExtrinsicLen | undefined
    >;
     ...
     *
     * @param {Callback<FrameSystemLimitsBlockLength> =} callback
     **/
    dynamicBlockLength: GenericStorageQuery<
      Rv,
      () => FrameSystemLimitsBlockLength
    >;
  ...
  balances: {
    ...
    freezes: GenericStorageQuery<
      ...
      (
        arg: AccountId32Like,
      ) => Array<PalletBalancesIdAmountRuntimeFreezeReason>,
      AccountId32
    >;
  ...
  session: {
     ...
     *
     * @param {Callback<Array<[AccountId32, DaRuntimePrimitivesSessionKeys]>> =} callback
     **/
    queuedKeys: GenericStorageQuery<
      Rv,
      () => Array<[AccountId32, DaRuntimePrimitivesSessionKeys]>
    >;
     ...
     *
     * @param {AccountId32Like} arg
     * @param {Callback<DaRuntimePrimitivesSessionKeys | undefined> =} callback
     **/
    nextKeys: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => DaRuntimePrimitivesSessionKeys | undefined,
      AccountId32
    >;
  ...
  technicalCommittee: {
     ...
     *
     * @param {H256} arg
     * @param {Callback<DaRuntimeRuntimeCall | undefined> =} callback
     **/
    proposalOf: GenericStorageQuery<
      Rv,
      (arg: H256) => DaRuntimeRuntimeCall | undefined,
      H256
    >;
  ...
  /**
   * Pallet `DataAvailability`'s storage queries
   **/
  dataAvailability: {
    /**
     * Last application ID
     *
     * @param {Callback<AvailCoreAppId> =} callback
     **/
    nextAppId: GenericStorageQuery<Rv, () => AvailCoreAppId>;

    /**
     * Store all application keys.
     *
     * @param {BytesLike} arg
     * @param {Callback<DaControlAppKeyInfo | undefined> =} callback
     **/
    appKeys: GenericStorageQuery<
      Rv,
      (arg: BytesLike) => DaControlAppKeyInfo | undefined,
      Bytes
    >;
     ...
     *
     * @param {Callback<FrameSupportDispatchDispatchFeeModifier> =} callback
     **/
    submitDataFeeModifier: GenericStorageQuery<
      Rv,
      () => FrameSupportDispatchDispatchFeeModifier
    >;
  ...
  /**
   * Pallet `Vector`'s storage queries
   **/
  vector: {
    /**
     ...
     * @param {Callback<bigint> =} callback
     **/
    head: GenericStorageQuery<Rv, () => bigint>;
     ...
     * @param {Callback<H256> =} callback
     **/
    headers: GenericStorageQuery<Rv, (arg: bigint) => H256, bigint>;
     ...
     * @param {Callback<bigint> =} callback
     **/
    timestamps: GenericStorageQuery<Rv, (arg: bigint) => bigint, bigint>;
     ...
     * @param {Callback<H256> =} callback
     **/
    executionStateRoots: GenericStorageQuery<Rv, (arg: bigint) => H256, bigint>;
     ...
     **/
    syncCommitteePoseidons: GenericStorageQuery<
      Rv,
      (arg: bigint) => U256,
      bigint
    >;
     ...
     *
     * @param {Callback<PalletVectorStateConfiguration> =} callback
     **/
    configurationStorage: GenericStorageQuery<
      Rv,
      () => PalletVectorStateConfiguration
    >;
     ...
     *
     * @param {H256} arg
     * @param {Callback<PalletVectorStorageUtilsMessageStatusEnum> =} callback
     **/
    messageStatus: GenericStorageQuery<
      Rv,
      (arg: H256) => PalletVectorStorageUtilsMessageStatusEnum,
      H256
    >;
     ...
     * @param {Callback<H256> =} callback
     **/
    broadcasters: GenericStorageQuery<Rv, (arg: number) => H256, number>;
     ...
     * @param {Callback<boolean> =} callback
     **/
    sourceChainFrozen: GenericStorageQuery<
      Rv,
      (arg: number) => boolean,
      number
    >;
     ...
     * @param {Callback<Array<number>> =} callback
     **/
    whitelistedDomains: GenericStorageQuery<Rv, () => Array<number>>;
     ...
     *
     * @param {Callback<[H256, H256] | undefined> =} callback
     **/
    functionIds: GenericStorageQuery<Rv, () => [H256, H256] | undefined>;
     ...
     * @param {Callback<Bytes | undefined> =} callback
     **/
    stepVerificationKey: GenericStorageQuery<Rv, () => Bytes | undefined>;
     ...
     * @param {Callback<Bytes | undefined> =} callback
     **/
    rotateVerificationKey: GenericStorageQuery<Rv, () => Bytes | undefined>;
     ...
     * @param {Callback<H256> =} callback
     **/
    genesisValidatorRoot: GenericStorageQuery<Rv, () => H256>;
     ...
     * @param {Callback<bigint> =} callback
     **/
    genesisTimestamp: GenericStorageQuery<Rv, () => bigint>;
     ...
     * @param {Callback<bigint> =} callback
     **/
    secondsPerSlot: GenericStorageQuery<Rv, () => bigint>;
     ...
     * @param {Callback<bigint> =} callback
     **/
    sourceChainId: GenericStorageQuery<Rv, () => bigint>;
     ...
     * @param {Callback<H256> =} callback
     **/
    updater: GenericStorageQuery<Rv, () => H256>;
     ...
     * @param {Callback<H256> =} callback
     **/
    syncCommitteeHashes: GenericStorageQuery<Rv, (arg: bigint) => H256, bigint>;
     ...
     * @param {Callback<H256> =} callback
     **/
    sp1VerificationKey: GenericStorageQuery<Rv, () => H256>;
     ...
     * @param {Callback<boolean> =} callback
     **/
    mockEnabled: GenericStorageQuery<Rv, () => boolean>;
  ...
  txPause: {
     ...
     **/
    pausedCalls: GenericStorageQuery<
      Rv,
  ...
  /**
   * Pallet `TreasuryCommittee`'s storage queries
   **/
  treasuryCommittee: {
    /**
     * The hashes of the active proposals.
